...
namespace Drupal\api_layer\Plugin\QueueWorker;
...
* )
*/
final class ExternalNewsQueueWorker extends QueueWorkerBase implements ContainerFactoryPluginInterface 
{
    ...
    */
    public function processItem($data) 
    {
        ...
        if (function_exists('api_layer_'.$source.'_to_entity'))
        {
            call_user_func('api_layer_'.$source.'_to_entity', $item);
        }
